...
----telescope.setup {
----  defaults = {
----    prompt_prefix = "Telescope Alberto > "
----  }
----}
...
--vim.command=sdf lua require'nvim-telescope'.search_dotfiles()
--vim.command=lgif lua require'nvim-telescope'.live_grep_in_folder()

return M


--require('nvim-telescope').search_dotfiles({ hidden = true })<CR>
--require('nvim-telescope').search_dotfiles({ hidden = true })<CR>
